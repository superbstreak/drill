...
class DrillClientQueryHandle{
    ...
    // Alternatively, we could also check for getQuery, but that could still be easily exploited 
    // by flipping the rpc type during fuzzing and resulted in a non recoverable crash.
